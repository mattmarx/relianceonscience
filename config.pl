...
$INPUTDIR_PATENTS_BODY="$NPL_BASE" . "/nplmatch/inputs/body/fulltext_2020/bodybyrefyear/"; # Input files of format body_YYYY.tsv
...
$INPUTDIR_JOURNAL_FRONT="$NPL_BASE" . "/nplmatch/inputs/npl/checkeveryjournal/journalbyrefyear/"; # Input files of format journalfront_YYYY.tsv
$INPUTDIR_JOURNAL_BODY="$NPL_BASE" . "/nplmatch/inputs/body/checkeveryjournal/journalbodybyrefyear/"; # Input files of format journalbody_YYYY.tsv
