...
perl $NPL_BASE/nplmatch/inputs/body/frankenfilter_jeren.pl $NPL_BASE/nplmatch/inputs/body/fulltext_2020/windows-$PARAS_ID > $NPL_BASE/nplmatch/inputs/body/fulltext_2020/filtered-$PARAS_ID 2> $NPL_BASE/nplmatch/inputs/body/fulltext_2020/skipped-$PARAS_ID
