...
perl $NPL_BASE/nplmatch/inputs/body/parajustdumpyearwindows.pl $NPL_BASE/nplmatch/inputs/body/fulltext_g19762004/cleanparas-$PARAS_ID > $NPL_BASE/nplmatch/inputs/body/fulltext_g19762004/windows-$PARAS_ID
