...
cat ../frontpage19472019usintl.tsv  | sort -u | fgrep --color=always -f journalsandabbrevswithspacetogrep.tsv | sort -u > matchedjournalscolorwithspace.tsv

cat ../frontpage19472019usintl.tsv  | sort -u | fgrep --color=always -f journalsandabbrevsnospacetogrep.tsv | sort -u > matchedjournalscolornospace.tsv
