...
compress
save scored_both_mag_bestonlyexport2020, replace
export delimited using scored_both_mag_bestonlyexport2020.tsv, replace delim(tab)
//
 ...
 * export the final file with DOIs and PMIDs
 use  scored_both_mag_bestonlyexport2020, clear
 joinby magid using magdoi, unmatched(master)
 drop _merge
 duplicates drop magid patent, force
 joinby magid using xwalkmagidpmid, unmatched(master)
 drop _merge
 duplicates drop magid patent, force
...
//  rename pmidcombo pmids
 compress
//  drop year author
 save scored_both_mag_doi_pmid_bestonlyexport2020, replace
 export delimited using scored_both_mag_doi_pmid_bestonlyexport2020.tsv, replace delim(tab)
