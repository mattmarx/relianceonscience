...
do
 ...
 do
  qsub -V -P marxnsf1 -N st_ws_ft -hold_jid xt_ws_ft -o year_regex_scored_front_wos_lev/scored$year-$jobnum.txt ../process_matches/score_matches.pl year_regex_output_front_wos_lev/year$year-$jobnum.txt
 done
done
