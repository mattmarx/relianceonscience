...
do
 ...
 do
  #qsub -N xt_ws_ft -hold_jid bt_ws_ft -l h_rt=96:00:00 -o year_regex_output_front_wos_lev/year$year-$jobnum.txt -b y year_regex_scripts_front_wos_lev/year$year-$jobnum.pl
  qsub -N xt_ws_ft -hold_jid bt_ws_ft  -o year_regex_output_front_wos_lev/year$year-$jobnum.txt -b y year_regex_scripts_front_wos_lev/year$year-$jobnum.pl
 done
done
