...
perl $NPL_BASE/nplmatch/grobid/window/onepatperlinewindowjeren.pl < $NPL_BASE/nplmatch/inputs/body/epo_2020/windows-$PARAS_ID > $NPL_BASE/nplmatch/grobid/window/window_epo2020/windowscombined-$PARAS_ID
