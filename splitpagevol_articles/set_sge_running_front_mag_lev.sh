...
do
 ...
 do
  #qsub -V -N xc_mg_ft -hold_jid bc_mg_ft -o year_regex_output_front_mag_lev/year$year-$jobnum.txt -b y year_regex_scripts_front_mag_lev/year$year-$jobnum.pl
  qsub -N xc_mg_ft -hold_jid bc_mg_ft -l h_rt=96:00:00 -o year_regex_output_front_mag_lev/year$year-$jobnum.txt -b y year_regex_scripts_front_mag_lev/year$year-$jobnum.pl
 done
done
